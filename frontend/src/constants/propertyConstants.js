...
export const PROPERTY_ALL_LIST_REQUEST = 'PROPERTY_ALL_LIST_REQUEST'
export const PROPERTY_ALL_LIST_SUCCESS = 'PROPERTY_ALL_LIST_SUCCESS'
export const PROPERTY_ALL_LIST_FAIL = 'PROPERTY_ALL_LIST_FAIL'
